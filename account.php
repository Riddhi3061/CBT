...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="account.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Analysis</a></li>
...
if($rowcount == 0){
  echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$NOQ.'</td><td>'.$marks*$NOQ.'</td><td>'.$marks.'</td><td>'.$starttime.'</td><td>'.$endtime.'</td><td>'.$time.'&nbsp;min</td>
  ...
  <td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$NOQ.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$NOQ.'</td><td>'.$marks*$NOQ.'</td><td>'.$marks.'</td><td>'.$starttime.'</td><td>'.$time.'&nbsp;min</td>
  </tr>';
}
}
$c=0;
...
echo '<form action="update.php?q=quiz&step=2&eid='.$eid.'&n='.$sn.'&t='.$NOQ.'&qid='.$qid.'" method="POST"  class="form-horizontal">
<br />';
...
//header("location:dash.php?q=4&step=2&eid=$id&n=$NOQ");
}
//result display
