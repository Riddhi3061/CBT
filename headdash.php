...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="headdash.php?q=0"><b>Dashboard - Super Admin</b></a>
    </div>
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Start Time</b></td><td><b>End Time</b></td><td><b>Time limit</b></td><td></td></tr>';
$c=1;
...
if($rowcount == 0){
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$NOQ.'</td><td>'.$mark*$NOQ.'</td><td>'.$mark.'</td><td>'.$starttime.'</td><td>'.$endtime.'</td><td>'.$time.'&nbsp;min</td>
	</tr>';
}
else
{
