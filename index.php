  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#" data-toggle="modal" data-target="#login">SUPER ADMIN</a></li>
        ...
        <li><a href="#" data-toggle="modal" data-target="#myModal1">SIGN UP</a></li>
         <li><a href="#" data-toggle="modal" data-target="#login2">ADMIN</a></li>
...
<div class="jumbotron text-center">
  <h1>Acharya Acadamy</h1> 
  <p>CBT - Online Examination</p> 
  <!--  form>
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-7">
      ...
      <h4><strong>What We Do --- </strong> The EdgyTech Solutions is an integrated part of the 1729 Acharya Academy Pvt. Ltd. Working towards an objective to build tech solutions in EdTech space.
The first milestone in this journey is to build a full phase Learning Management System (LMS). We have narrowed down the Computer Based Test (CBT) as the first module, which we need to build. </h4><br>
    </div>
  </div>
</div>
